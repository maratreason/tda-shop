      ...
      <div class="container">
        ...
        <div class="product">
          <div class="product-img">
            <ul class="product-img__list">
              <li class="product-img__item is--active"><img class="product-img__picture" src="/images/products/product-1.png" alt=""></li>
              <li class="product-img__item"><img class="product-img__picture" src="/images/products/product-1.png" alt=""></li>
              <li class="product-img__item"><img class="product-img__picture" src="/images/products/product-1.png" alt=""></li>
            </ul><img class="product-img__picture-big" src="/images/products/product-big.png" alt="big product picture">
          </div>
          <div class="product-content">
            ...
            <div class="product-content__description">
              ...
              <ul class="product-content__description-list">
                <li class="product-content__description-item">В упаковке <span>210x120x100 мм (ДxШxВ)</span></li>
        ...
        <div class="section-catalog__products-slider swiper">
          ...
          <div class="section-promotional__btns swiper-buttons">
            <button class="section-promotional__btn swiper-button-prev btn btn-rounded btn-rounded--filled-active" data-btn="catalog-prev">
              <div class="btn-rounded__img">
            ...
            <button class="section-promotional__btn swiper-button-next btn btn-rounded btn-rounded--filled-active" data-btn="catalog-next">
              <div class="btn-rounded__img">
                <svg width="12" height="12" viewBox="0 0 14 14" fill="" xmlns="http://www.w3.org/2000/svg">
                  <path d="M13 7L13.7071 7.70711C14.0976 7.31658 14.0976 6.68342 13.7071 6.29289L13 7ZM6.29289 12.2929C5.90237 12.6834 5.90237 13.3166 6.29289 13.7071C6.68342 14.0976 7.31658 14.0976 7.70711 13.7071L6.29289 12.2929ZM7.70711 0.292893C7.31658 -0.0976315 6.68342 -0.0976315 6.29289 0.292893C5.90237 0.683417 5.90237 1.31658 6.29289 1.70711L7.70711 0.292893ZM1 6C0.447715 6 0 6.44772 0 7C0 7.55228 0.447715 8 1 8L1 6ZM12.2929 6.29289L6.29289 12.2929L7.70711 13.7071L13.7071 7.70711L12.2929 6.29289ZM6.29289 1.70711L12.2929 7.70711L13.7071 6.29289L7.70711 0.292893L6.29289 1.70711ZM1 8H13V6L1 6L1 8Z" fill=""></path>
                </svg>
