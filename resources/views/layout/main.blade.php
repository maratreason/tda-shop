...
<body id="top">
    <header class="header">
        <div class="header-wrapper">
            <div class="container">
                <div class="header__top"><a class="header__top-logo logo" href="{{ route('index') }}">
                            ...
                            @isset($categories)
                                @foreach ($categories as $menu)
                                    <li class="header__bottom-item">
                                        <a class="header__bottom-link" href="/{{$menu->alias}}">{{$menu->title}}</a>
                                    </li>
                                @endforeach
                            @endisset
                        </ul>
