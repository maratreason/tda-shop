      ...
      <div class="container">
        <div class="breadcrumbs">
          <ul class="breadcrumbs__list">
            ...
            <li class="breadcrumbs__item"><a class="breadcrumbs__link" href="/">Овощи, Фрукты, Зелень, Грибы</a></li>
          </ul>
        </div>
        <div class="title-2 section-catalog__title">{{ $category }}</div>
        <div class="catalog-detail__filter">
          <button class="btn btn-rounded" data-catalog-filter><svg width="22" height="20" viewBox="0 0 22 20" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M21 1H1L9 10.46V17L13 19V10.46L21 1Z" stroke="#82BA01" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
          </button><a class="link" href="" data-catalog-filter>Фильтр</a>
        </div>
        <div class="catalog-detail__inner">
          <div class="catalog-detail__sitebar sitebar" data-catalog-filter-content><a class="sitebar__header" href="#">
              <svg width="10" height="12" viewBox="0 0 10 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M5 9L1 5L5 1" stroke="#272727" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
            ...
            <div class="accordion" data-accordion>
                ...
                <div class="sitebar__box-item accordion__content" data-accordion-content>
                  <div class="sitebar__box-range">
                    ...
                    <div class="range-input">
                      <input class="range-min" type="range" min="0" max="10000" value="2500" step="10">
                      <input class="range-max" type="range" min="0" max="10000" value="7500" step="10">
                    </div>
              ...
              <div class="sitebar__box accordion__control" data-accordion-control>
                <div class="sitebar__title accordion__title title-4" data-accordion-title>Тип продукта</div>
                <div class="sitebar__box-item accordion__content" data-accordion-content>
          ...
          <div class="catalog-detail__content">
            <div class="catalog-detail__content-top">
              <div class="catalog-detail__content-changes">
                <div class="select" data-select>
                  <div class="select-text"><span>Показывать по 40</span>
                    <div class="btn-dropdown__icon"><img src="/images/icons/chevron-down.svg" alt="" data-select-icon></div>
                  </div>
              ...
              <div class="catalog-detail__content-btns">
                <button class="btn btn-rounded btn-primary"><img src="/images/icons/more-vertical.svg" alt=""></button>
                <button class="btn btn-rounded btn-primary-outlined"><img src="/images/icons/more-horizontal.svg" alt=""></button>
              </div>
            </div>
            <ul class="catalog-detail__chips-list">
              <li class="catalog-detail__chips-item">
                <button class="btn btn-success btn-chips">Со скидкой<img src="/images/icons/exit.svg" alt=""></button>
              </li>
              <li class="catalog-detail__chips-item">
            ...
            <div class="catalog-detail__content-products">
              <div class="product-card">
                <div class="product-card__img-wrapper"><img class="product-card__img" src="/images/products/product-1.png" alt="">
                ...
                <div class="product-card__btns">
                  <div class="product-card__count count" data-count>
                    <button class="product-card__count-btn count-btn count-btn__minus" data-count-btn-minus="true">-</button>
                    <div class="product-card__count-number" data-count-number>1</div>
                    <button class="product-card__count-btn count-btn count-btn__plus" data-count-btn-plus="true">+</button>
                  </div>
